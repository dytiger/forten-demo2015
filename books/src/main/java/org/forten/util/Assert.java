...
public class Assert {
	 ...
	 *            错误消息文本
	 */
	public static <T extends Comparable<T>> void isBetween(T value, T min, T max, String message) {
	...
	public static <T extends Comparable<T>> void isBetween(T value, T min, T max) {
		isBetween(value, min, max, String.format(MUST_BETWEEN_MSG, value, min, max));
	}
	...
	public static void isInstanceOf(Class<?> clazz, Object obj) {
		isInstanceOf(clazz, obj,
				String.format(IS_INSTANCE_OF_MSG, (obj != null ? obj.getClass().getName() : "null"), clazz));
	}
	...
	public static void matchesPattern(String input, String pattern) {
		matchesPattern(input, pattern, String.format(NOT_MATCH_PATTERN_MSG, input, pattern));
	}
}
